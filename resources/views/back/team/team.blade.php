...
@section('content')
    ...
    <div class="card m-5 shadow p-3 mb-5 bg-white rounded">
        ...
        <h5 class="card-header mb-3">Update Team</h5>
        <form action="{{route('update.title', $titles[3])}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="d-flex flex-column m-3 form-group">
                ...
                <input type="text" name="title" value="{{$titles[3]->title}}" class="form-control @error('title') is-invalid @enderror">
                @error('title')
